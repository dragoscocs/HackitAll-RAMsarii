...
public class MockDataService {
    ...
    // Simulated meetings as a map of "start:end" -> title
    private final List<Map<String, String>> dailyCalendar = new ArrayList<>();

    public MockDataService() {
        employees.add(new Employee(1L, "Gigel Popescu",  "Bucharest", List.of("Padel", "Tennis")));
        employees.add(new Employee(2L, "Ana Ionescu",    "Bucharest", List.of("Ping Pong", "Badminton")));
        employees.add(new Employee(3L, "Radu Mihalcea",  "Cluj",      List.of("Padel", "Football")));
        employees.add(new Employee(4L, "Maria Constantin","Bucharest", List.of("Ping Pong", "Yoga")));
        employees.add(new Employee(5L, "Bogdan Dumitrescu","Iași",    List.of("Tennis", "Cycling")));
    ...
    public List<Map<String, String>> getDailyCalendar() {
        return dailyCalendar;
    }

    /**
     * Finds the next gap of at least 15 minutes between meetings (or before first/after last).
     * Returns the suggested break time as a formatted string.
     */
    public String findNextBreakSlot() {
        ...
        return "12:00"; // fallback lunch break
    }
}
