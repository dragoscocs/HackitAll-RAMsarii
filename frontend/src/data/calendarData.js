...
function generateAna(e) {
  return [
    ...
    // Thursday
    e(0,3, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(0,4, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(1,4, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(2,4, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
    ...
    // Tuesday
    e(3,1, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(3,4, 9, 0, 9,15, 'Daily Standup — Echipa Produs',        'standup',    'Ana Ionescu'),
...
function generateAndrei(e) {
  return [
    // ── WEEK 0 ──────────────────────────────────────────────────────────────
    // Monday
    e(0,0, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Tuesday
    e(0,1, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Wednesday
    e(0,2, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Thursday
    e(0,3, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Friday
    e(0,4, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    e(0,4, 8,30, 9,30, 'Weekly Tech Sync',                     'team',       'Engineering Team'),
    e(0,4,10, 0,10,30, 'Code Freeze Checklist',                'review',     'Tech Lead Dan'),

    // ── WEEK 1 ──────────────────────────────────────────────────────────────
    // Monday
    e(1,0, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Tuesday
    e(1,1, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    e(1,2, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Thursday
    e(1,3, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Friday
    e(1,4, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    e(1,4, 8,30, 9,30, 'Weekly Tech Sync',                     'team',       'Engineering Team'),
    e(1,4,10,30,11, 0, 'Deployment Checklist Review',          'review',     'Tech Lead Dan'),

    // ── WEEK 2 ──────────────────────────────────────────────────────────────
    // Monday
    e(2,0, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Tuesday
    e(2,1, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Wednesday
    e(2,2, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Thursday
    e(2,3, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Friday
    e(2,4, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    e(2,4, 8,30, 9,30, 'Weekly Tech Sync',                     'team',       'Engineering Team'),
    e(2,4,10, 0,10,30, 'Release Notes Review',                 'review',     'Tech Lead Dan'),

    // ── WEEK 3 ──────────────────────────────────────────────────────────────
    // Monday
    e(3,0, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Tuesday
    e(3,1, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Wednesday
    e(3,2, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    e(3,3, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
    ...
    // Friday
    e(3,4, 8, 0, 8,15, 'Daily Standup — Backend Team',         'standup',    'Andrei Dumitrescu'),
...
function generateGigel(e) {
  return [
    // ── WEEK 0 ──────────────────────────────────────────────────────────────
    // Monday
    e(0,0,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Tuesday
    e(0,1,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Wednesday
    e(0,2,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Thursday
    e(0,3,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Friday
    e(0,4,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // ── WEEK 1 ──────────────────────────────────────────────────────────────
    // Monday
    e(1,0,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Tuesday
    e(1,1,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(1,2,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(1,3,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Friday
    e(1,4,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    e(1,4,10,30,11,30, 'Weekly Data Review',                   'review',     'Data Team'),
    e(1,4,16,30,17,30, 'End-of-Week Report Finalizare',        'review',     'Data Ops'),

    // ── WEEK 2 ──────────────────────────────────────────────────────────────
    // Monday
    e(2,0,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(2,1,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Wednesday
    e(2,2,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(2,3,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Friday
    e(2,4,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // ── WEEK 3 ──────────────────────────────────────────────────────────────
    // Monday
    e(3,0,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Tuesday
    e(3,1,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(3,2,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    e(3,3,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
    ...
    // Friday
    e(3,4,10, 0,10,15, 'Daily Standup — Data Team',            'standup',    'Gigel Popescu'),
...
function generateDefault(e) {
  return [
    ...
    // Monday
    e(0,0, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    e(0,0,15,15,16, 0, 'Revizie Documentație GDPR',              'review',     'Legal Team'),
    // Tuesday
    e(0,1, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Wednesday
    e(0,2, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Thursday
    e(0,3, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(0,3, 9,30,10,30, 'Regulatory Compliance Update',           'review',     'Compliance Team'),
    ...
    e(0,3,16, 0,17, 0, 'Risk Assessment Q2',                     'review',     'Risk Team'),
    // Friday
    e(0,4, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(0,4,10, 0,10,30, 'Weekly Wrap-up',                         'team',       'Victor Dumitrescu'),
    e(0,4,11, 0,11,30, 'Planificare Săptămâna Viitoare',         'planning',   'Cristina Marin'),

    // ── WEEK 1 (refinement week) ─────────────────────────────────────────────
    // Monday
    e(1,0, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(1,0, 9,30,10,30, 'Refinement Sprint Backlog',              'planning',   'Victor Dumitrescu'),
    ...
    // Tuesday
    e(1,1, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Wednesday
    e(1,2, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(1,2,10,30,11,30, 'Grooming Sprint Backlog',                'planning',   'Victor Dumitrescu'),
    ...
    // Thursday
    e(1,3, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(1,4, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(1,4,10, 0,10,30, 'Weekly Wrap-up',                         'team',       'Victor Dumitrescu'),
    e(1,4,11, 0,11,30, 'Planificare Săptămâna Viitoare',         'planning',   'Cristina Marin'),

    // ── WEEK 2 (sprint planning week) ───────────────────────────────────────
    // Monday
    e(2,0, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Tuesday
    e(2,1, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Wednesday
    e(2,2, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Thursday
    e(2,3, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(2,4, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(2,4,10, 0,10,30, 'Weekly Wrap-up',                         'team',       'Victor Dumitrescu'),
    e(2,4,11, 0,11,30, 'Planificare Săptămâna Viitoare',         'planning',   'Cristina Marin'),

    // ── WEEK 3 (refinement week) ─────────────────────────────────────────────
    // Monday
    e(3,0, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(3,0, 9,30,10,30, 'Refinement Sprint Backlog',              'planning',   'Victor Dumitrescu'),
    e(3,0,13, 0,13,30, '1:1 cu Managerul',                       'one-on-one', 'Cristina Marin'),
    e(3,0,14, 0,15, 0, 'Sync Proiecte Active',                   'team',       'Bogdan Popa'),
    // Tuesday
    e(3,1, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Wednesday
    e(3,2, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    e(3,2,10,30,11,30, 'Grooming Sprint Backlog',                'planning',   'Victor Dumitrescu'),
    ...
    e(3,2,15, 0,16, 0, 'Release Readiness Review',               'review',     'Release Team'),
    // Thursday
    e(3,3, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
    ...
    // Friday
    e(3,4, 9, 0, 9,15, 'Daily Standup — Echipa Retail Banking',  'standup',    'Ana Ionescu'),
